...
void Mesh::Draw(Direct3D11Renderer& pd3dRenderer, DirectX::XMMATRIX cameraMatrix, DirectX::FXMMATRIX accumulatedTransform)
{
...
void Node::Draw(Direct3D11Renderer& pd3dRenderer, DirectX::XMMATRIX cameraMatrix, DirectX::FXMMATRIX accumulatedTransform)
{
...
void Model::Draw(Direct3D11Renderer& pd3dRenderer, DirectX::XMMATRIX cameraMatrix, float posX, float posY, float posZ, float scaleX, float scaleY, float scaleZ)
{
